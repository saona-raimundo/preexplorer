...
plot "data/1_0.txt" using (hist_0($1,width_0)):(1.0/len_0) smooth frequency with steps title "My legend" dt 1, \
"data/1_1.txt" using (hist_1($1,width_1)):(1.0/len_1) smooth frequency with steps title "1" dt 2, 
pause -1
